...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const currentTextLength = positions[currentPosition].length;
  ...
  return (
    <>
      <div
  className="relative w-screen h-screen bg-[url('/public/me.png')] bg-[position:720px_center] md:bg-[position:1020px_center] bg-cover lg:bg-cover lg:bg-center"
>
        <div className="absolute inset-0 overflow-hidden">
          <div className="overlay grid lg:grid-cols-10 sm:grid-cols-3 grid-rows-3 ">
      ...
      >
        <div className="sm:pl-0 md:pl-4 lg:pl-20">
          ...
          <h1 className="text-2xl sm:text-2xl lg:text-5xl font-bold flex justify-center sm:justify-start">
            My Name Is <span className="text-yellow-500  pl-2 sm:pl-4 ">Subith</span>
          </h1>
          <p className="text-lg sm:text-2xl lg:text-4xl mt-2">
            As a{' '}
            <p
              className={`text-lg sm:text-2xl lg:text-4xl mt-2 cssanimation typing ${
                isTyping ? 'typing' : 'reverseTyping'
              }`}
            >
